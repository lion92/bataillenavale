...
function Todo() {
    ...
    this.reqbateau = function (token, nom, bateauX, bateauY, partie, req, res) {
        console.log(token);
        console.log(partie);
        console.log(nom);
        let conection2 = false;
    ...
    this.reqtir = function (token, posX, posY, adversaire, req, res) {
                    ...
                    function (err, result) {
                        ...
                        if (err) {
                            ...
                            res.send({
                                status: 0,
                                message:
                                    "Tirer en POsX " + posX + " posY : " + posY + "par " + email + "sur" + adversaire,
                            });
                            //console.log("Post successful");
                        }
                    }
    ...
    this.reqpartie = function (token, joueur2, tourj1, req, res) {
        console.log(token);
        console.log(joueur2);
        let conection2 = false;
        let email = "";
                    ...
                    if (err) {
                        ...
                        if (tourj1 == 1) {
                            ...
                            res.send({
                                status: 0,
                                message:
                                    "c est au tour de votre adversaire" + JSON.stringify(result),
                            });
                            //console.log("Post successful");
                        }
                    }
    ...
    this.quiesttu = function (token, req, res) {
        let conection2 = false;
        let email = "";
        jwt.verify(token, "secret_this_should_be_longer", function (err, decoded) {
            //console.log("////////////");
            if (decoded === undefined) {
                conection2 = true;
                //console.log("true");
